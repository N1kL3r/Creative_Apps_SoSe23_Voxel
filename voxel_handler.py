...
# has access to world instance
class VoxelHandler:
    def __init__(self, world):
        self.app = world.app
        self.chunks = world.chunks

        # attributes related to results of the ray casting function
        self.chunk = None
        self.voxel_id = None
    ...
    def ray_cast(self):
        ...
        while not (max_x > 1.0 and max_y > 1.0 and max_z > 1.0):
            ...
            # new position of the voxel is calculated
            if result[0]:
