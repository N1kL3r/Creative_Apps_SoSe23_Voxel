...
# create Chunk class: Its content will define an array of voxels
...
class Chunk:
    def __init__(self, world, position):
        ...
        self.is_empty = True            # avoid empty chunks to be drawn
    ...
    # model coordinates in the world
    def get_model_matrix(self):
        m_model = glm.translate(glm.mat4(), glm.vec3(self.position) * CHUNK_SIZE)
        return m_model

    # set method in uniform as a shader
    ...
    def build_voxels(self):
        ...
        # voxel id is a number between 0-255 where 0  is empty space
        # no 3D, instead one dimensional arrays will be used
        # fill chunk and all voxels will be given value of 1
