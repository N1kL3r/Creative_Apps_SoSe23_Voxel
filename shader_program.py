...
# create class for shader which bears the same name
class ShaderProgram:
    ...
    # pass identity model matrix to shader
    ...
    def get_program(self, shader_name):
        # create shader files and load them using context manager
        with open(f'shaders/{shader_name}.vert') as file:
            vertex_shader = file.read()

        with open(f'shaders/{shader_name}.frag') as file:
            fragment_shader = file.read()
        # return instance of s hader program
